...
Veja o [guia completo de remediação de solos contaminados em Portugal](/blog/guia-remediacao-solos-contaminados-portugal/).
...
<figure>
<svg viewBox="0 0 560 210" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Diagrama das 3 fases de avaliação de solos APA 2022">
  <title>3 Fases de Avaliação de Solos — Guia Técnico APA 2022</title>
  <defs>
    <marker id="arr1" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto">
      <path d="M0,0 L7,3.5 L0,7 Z" fill="#94a3b8"/>
    </marker>
  </defs>
  <rect width="560" height="210" fill="#f7f9f9" rx="8"/>
  <!-- Phase 1 -->
  <rect x="18" y="55" width="155" height="90" rx="7" fill="#0B3B2E"/>
  <text x="96" y="88" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="white" text-anchor="middle">FASE 1</text>
  <text x="96" y="107" font-family="system-ui,sans-serif" font-size="10" fill="#a7f3d0" text-anchor="middle">Avaliação Preliminar</text>
  <text x="96" y="123" font-family="system-ui,sans-serif" font-size="9" fill="#6ee7b7" text-anchor="middle">Sem amostragem</text>
  <!-- Arrow 1 -->
  <path d="M173 100 L200 100" stroke="#94a3b8" stroke-width="2" marker-end="url(#arr1)"/>
  <!-- Phase 2 -->
  <rect x="200" y="55" width="155" height="90" rx="7" fill="#155e42"/>
  <text x="278" y="88" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="white" text-anchor="middle">FASE 2</text>
  <text x="278" y="107" font-family="system-ui,sans-serif" font-size="10" fill="#a7f3d0" text-anchor="middle">Inv. Exploratória</text>
  <text x="278" y="123" font-family="system-ui,sans-serif" font-size="9" fill="#6ee7b7" text-anchor="middle">Primeiras amostragens</text>
  <!-- Arrow 2 -->
  <path d="M355 100 L382 100" stroke="#94a3b8" stroke-width="2" marker-end="url(#arr1)"/>
  <!-- Phase 3 -->
  <rect x="382" y="55" width="160" height="90" rx="7" fill="#1d7a52"/>
  <text x="462" y="88" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="white" text-anchor="middle">FASE 3</text>
  <text x="462" y="107" font-family="system-ui,sans-serif" font-size="10" fill="#a7f3d0" text-anchor="middle">Inv. Detalhada</text>
  <text x="462" y="123" font-family="system-ui,sans-serif" font-size="9" fill="#6ee7b7" text-anchor="middle">Dossier APA / CCDR</text>
  <!-- Source label -->
  <text x="280" y="192" font-family="system-ui,sans-serif" font-size="9" fill="#64748b" text-anchor="middle">Fonte: APA, Guia Técnico de Gestão e Reabilitação de Solos Contaminados, novembro 2022</text>
</svg>
<figcaption>Fonte: APA, Guia Técnico de Gestão e Reabilitação de Solos Contaminados, novembro 2022</figcaption>
</figure>
...
A APA publicou em maio de 2025 a Nota Técnica v2 sobre classificação de solos e rochas escavadas como subproduto, que clarifica os critérios de aplicação do DL 102-D/2020 especificamente para solos de escavação ([APA Nota Técnica v2](https://www.apambiente.pt/), maio 2025). Esta nota introduz requisitos documentais mais exigentes: declaração do produtor de resíduos e verificação analítica prévia à transferência são agora condições explícitas.

<figure>
<svg viewBox="0 0 560 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Árvore de decisão subproduto versus resíduo ao abrigo do DL 102-D/2020">
  <title>Solos Escavados: Subproduto ou Resíduo? — DL 102-D/2020</title>
  <defs>
  ...
  <text x="280" y="26" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="#1e293b" text-anchor="middle">Solos Escavados — Classificação ao abrigo do DL 102-D/2020</text>
  <!-- Question box -->
  <rect x="155" y="42" width="250" height="52" rx="7" fill="#0B3B2E"/>
  <text x="280" y="63" font-family="system-ui,sans-serif" font-size="10" fill="white" text-anchor="middle">As 4 condições cumulativas</text>
  <text x="280" y="81" font-family="system-ui,sans-serif" font-size="10" fill="#a7f3d0" text-anchor="middle">estão todas verificadas?</text>
  <!-- Yes arrow (down) -->
  <path d="M280 94 L280 128" stroke="#22c55e" stroke-width="2.5" marker-end="url(#arrG)"/>
  <text x="294" y="116" font-family="system-ui,sans-serif" font-size="10" font-weight="600" fill="#16a34a">Sim</text>
  <!-- Subproduto box -->
  <rect x="155" y="128" width="250" height="55" rx="7" fill="#166534"/>
  <text x="280" y="152" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="white" text-anchor="middle">SUBPRODUTO</text>
  <text x="280" y="170" font-family="system-ui,sans-serif" font-size="9" fill="#86efac" text-anchor="middle">Reutilização direta · Registo documental</text>
  <!-- No arrow (left) -->
  <path d="M155 68 L78 68 L78 155" stroke="#ef4444" stroke-width="2.5" marker-end="url(#arrR)"/>
  <text x="84" y="62" font-family="system-ui,sans-serif" font-size="10" font-weight="600" fill="#dc2626">Não</text>
  <!-- Residuo box -->
  <rect x="14" y="155" width="208" height="55" rx="7" fill="#991b1b"/>
  <text x="118" y="179" font-family="system-ui,sans-serif" font-size="13" font-weight="700" fill="white" text-anchor="middle">RESÍDUO</text>
  <text x="118" y="197" font-family="system-ui,sans-serif" font-size="9" fill="#fca5a5" text-anchor="middle">Operador licenciado · €30–80/tonelada</text>
  <!-- Footer notes -->
  <text x="280" y="235" font-family="system-ui,sans-serif" font-size="9" fill="#64748b" text-anchor="middle">Coimas por classificação incorreta: até €44.891 (DL 102-D/2020)</text>
  <text x="280" y="250" font-family="system-ui,sans-serif" font-size="9" fill="#64748b" text-anchor="middle">Nota Técnica APA v2 (maio 2025): verificação analítica prévia à transferência é condição obrigatória</text>
</svg>
<figcaption>Fonte: DL 102-D/2020 e APA Nota Técnica v2, maio 2025</figcaption>
</figure>
...
Veja o guia completo em [solos escavados: subproduto ou resíduo (APA 2025)](/blog/solos-escavados-subproduto-residuo-apa-2025/).
...
Próximo passo: [guia completo de remediação de solos contaminados em Portugal](/blog/guia-remediacao-solos-contaminados-portugal/).
